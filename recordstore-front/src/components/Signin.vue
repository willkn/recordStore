  ...
  <div>
      ...
      <form>
          <label for="email">Email
            <input align="center" class="inputField" id="email" type="email" placeholder="Email" v-model="email">
          </label>
          <br>
          <label for="password">Password
            <input align="center" class="inputField" id="password" type="password" placeholder="Password" v-model="password">
          </label>
          <br>
